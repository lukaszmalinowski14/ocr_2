# first is the table detection and cell recognition with Open cv2
#
...
######
im = Image.open(r'C:/Python/ocr_2/page2.jpg')
...
im1 = im.crop((5120, 4003, 6556, 4606))
im1.show()
im1 = im1.save(r"C:/Python/ocr_2/table.jpg")
# file = r"C:/Python/ocr_2/table.jpg"
######
img = cv2.imread(file, 0)
img.shape
# 1 thresholding the image to a binary image
...
img_bin = 255-img_bin
cv2.imwrite(r'C:/Python/ocr_2/cv2_inverted.png', img_bin)

# 2
th3 = 255-th3
cv2.imwrite(r'C:/Python/ocr_2/th3_inverted.png', th3)

# 1 Plotting the image to see the output
plotting = plt.imshow(img_bin, cmap='gray')
plt.show()

# 2 th3
plotting2 = plt.imshow(th3, cmap='gray')
plt.show()
...
data.to_excel(str(Path.cwd())+'/output.xlsx')
####################################################################
print("Hello")
